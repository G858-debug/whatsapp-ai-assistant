...
class HabitService:
    ...
    def delete_habit(
        ...
        """
        Soft delete a habit (set is_active = False). Related habit_logs remain for historical data.
        ...
        try:
            ...
            # Soft delete the habit (habit_logs will be handled by CASCADE constraint)
