...
CREATE TABLE IF NOT EXISTS notification_queue (
    ...
    INDEX idx_notification_queue_user (user_id, user_type),
    INDEX idx_notification_queue_scheduled (scheduled_for, sent),
...
CREATE TABLE IF NOT EXISTS dashboard_updates (
    ...
    INDEX idx_dashboard_updates_user (user_id, user_type),
    INDEX idx_dashboard_updates_created (created_at),
    INDEX idx_dashboard_updates_processed (processed)
);
