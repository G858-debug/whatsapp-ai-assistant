...
6. services/message_router/handlers/buttons/button_handler.py (handle_button_response)
   ↓ routes to registration_handler (as button_id in "register_trainer")
7. services/message_router/handlers/buttons/registration_buttons.py (_handle_register_trainer (as button_id in "register_trainer"))
